...
///
/// Returns ``std::nullopt`` if it does not converge.
///
template <class SequenceContainer>
std::optional<typename SequenceContainer::value_type> iterativeMean(
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, SO2<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar) {
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, RxSO2<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar) {
  size_t N = std::distance(std::begin(foo_Ts_bar), std::end(foo_Ts_bar));
  SOPHUS_ENSURE(N >= 1, "N must be >= 1.");
...
//
// TODO: Detect degenerated cases and return std::nullopt.
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, SO3<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar) {
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, RxSO3<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar) {
  size_t N = std::distance(std::begin(foo_Ts_bar), std::end(foo_Ts_bar));
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, SE2<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, Sim2<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar, int max_num_iterations = 20) {
  return iterativeMean(foo_Ts_bar, max_num_iterations);
}
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, SE3<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar, int max_num_iterations = 20) {
  return iterativeMean(foo_Ts_bar, max_num_iterations);
}
...
template <class SequenceContainer,
          class Scalar = typename SequenceContainer::value_type::Scalar>
std::enable_if_t<
    std::is_same_v<typename SequenceContainer::value_type, Sim3<Scalar> >,
    std::optional<typename SequenceContainer::value_type> >
average(SequenceContainer const& foo_Ts_bar, int max_num_iterations = 20) {
  return iterativeMean(foo_Ts_bar, max_num_iterations);
}
